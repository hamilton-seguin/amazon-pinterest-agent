...
const CATEGORY_KEYWORDS: Record<Category, string[]> = {
  travel: [
    'packing', 'cube', 'toiletry', 'organizer', 'luggage', 'travel',
    'charger', 'portable', 'neck pillow', 'carry-on',
  ],
  fashion: [
    'bag', 'crossbody', 'tote', 'scarf', 'beanie', 'hat',
    'jewelry', 'belt', 'wallet', 'sunglasses',
  ],
  beauty: [
    'mirror', 'organizer', 'skincare', 'brush', 'hair', 'vanity',
    'led', 'roller', 'gua sha', 'makeup',
  ],
  baby: [
    'nursery', 'crib', 'diaper', 'caddy', 'organizer', 'closet',
    'stroller', 'gift', 'baby travel', 'pacifier',
  ],
};

const USE_CASE_HINTS = [
  'for', 'set of', 'pack', 'with', 'compartment', 'portable',
  'foldable', 'travel', 'organizer', 'storage', 'gift',
];

const VISUAL_HINTS = [
  'led', 'clear', 'acrylic', 'rose', 'matte', 'velvet',
  'quilted', 'pastel', 'minimalist', 'aesthetic', 'wood', 'marble',
];
